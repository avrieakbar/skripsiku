                            ...
                            <div class="p-5">
                                ...
                                <form action="<?= route_to('register') ?>" method="post" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user <?php if (session('errors.nama')) : ?>is-invalid<?php endif ?>" name="nama" placeholder="Name" value="<?= old('nama') ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <select class="form-select form-control-user" name="size" value="<?= old('pihak'); ?>">
                                                <option selected type="option">Pilih Pihak</option>
                                                <option type="option" name="size" id="sizeOption1" value="Foreman">Foreman</option>
                                                <option type="option" name="size" id="sizeOption3" value="TOC">TOC</option>
                                            </select>
                                        </div>
